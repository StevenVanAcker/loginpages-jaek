...
if __name__ == '__main__':
    ...
    xxx = LoginPageChecker("CRAWL", None, hstspreloadchecker, autoExitFilename = "output-jaek.json", observedAuthSchemes=observedAuthSchemes, observedSSLHostPorts=observedSSLHostPorts)
